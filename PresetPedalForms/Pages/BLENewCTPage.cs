...
{
    public class BLENewCTPage : ContentPage
    {
        Button scanButton;
        Button pairedButton;
        public BLENewCTPage()
        {
            ...
            pairedButton = new Button { Text = "Paired to Controller", VerticalOptions = LayoutOptions.CenterAndExpand, HorizontalOptions = LayoutOptions.CenterAndExpand };
            ...
            Title = "Connect to New Controller";
